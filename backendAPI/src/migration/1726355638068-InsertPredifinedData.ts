...
export class InsertPredifinedData1726355638068 implements MigrationInterface {
    name = 'InsertPredifinedData1726355638068'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DELETE FROM "schein_type" WHERE "name" IN ('Mustersammlung', 'Zeugnis über den mutmaßlichen Tag der Entbindung', 'Verordnung einer Krankenbeförderung');`);
      }

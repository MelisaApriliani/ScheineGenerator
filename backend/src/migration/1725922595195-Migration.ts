...
export class Migration1725922595195 implements MigrationInterface {
    name = 'Migration1725922595195'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "doctor" ("id" SERIAL NOT NULL, "firstLame" character varying NOT NULL, "lastName" character varying NOT NULL, "specialization" character varying NOT NULL, "licenseNumber" character varying NOT NULL, "phoneNumber" character varying NOT NULL, "email" character varying NOT NULL, CONSTRAINT "PK_ee6bf6c8de78803212c548fcb94" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "patient" ("id" SERIAL NOT NULL, "firstLame" character varying NOT NULL, "lastName" character varying NOT NULL, "dateOfBirth" date NOT NULL, CONSTRAINT "PK_8dfa510bb29ad31ab2139fbfb99" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "schein" ("id" SERIAL NOT NULL, "date" TIMESTAMP, "type" character varying NOT NULL, "schein_type_id" integer NOT NULL, "patient_id" integer, "doctor_id" integer, CONSTRAINT "PK_cfb5084a1c9f8ee3bdcb2ced519" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_9df50a71cc1daf95f607af1482" ON "schein" ("type") `);
        ...
        await queryRunner.query(`ALTER TABLE "schein" ADD CONSTRAINT "FK_413c9c2fd12d7a6498b8f3010d3" FOREIGN KEY ("schein_type_id") REFERENCES "schein_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "schein" ADD CONSTRAINT "FK_283edcaa18ac921553914efd69a" FOREIGN KEY ("patient_id") REFERENCES "patient"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "schein" ADD CONSTRAINT "FK_0dc0df4b040551f5806676b2078" FOREIGN KEY ("doctor_id") REFERENCES "doctor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "schein" DROP CONSTRAINT "FK_0dc0df4b040551f5806676b2078"`);
        await queryRunner.query(`ALTER TABLE "schein" DROP CONSTRAINT "FK_283edcaa18ac921553914efd69a"`);
        await queryRunner.query(`ALTER TABLE "schein" DROP CONSTRAINT "FK_413c9c2fd12d7a6498b8f3010d3"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9df50a71cc1daf95f607af1482"`);

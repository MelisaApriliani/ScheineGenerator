...
export class Migration1726355561453 implements MigrationInterface {
    name = 'Migration1726355561453'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "patient_insurance" ("id" SERIAL NOT NULL, "insuranceNo" character varying NOT NULL, "status" character varying, "patient_id" integer, "insurance_provider_id" integer, CONSTRAINT "PK_29bd33325acf4c3794562bd53f0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "patient_insurance" ADD CONSTRAINT "FK_5650131c821e9e969437852a1ab" FOREIGN KEY ("insurance_provider_id") REFERENCES "insurance_provider"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "patient_insurance" DROP CONSTRAINT "FK_5650131c821e9e969437852a1ab"`);
